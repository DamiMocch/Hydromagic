              ...
              {testimonios.map((item, index) => {
                ...
                return (
                  <div
                    key={item.id}
                    className={`
                      relative shrink-0 w-[684px] h-[357px] mx-[38px]
                      rounded-[50px] overflow-hidden transition-all duration-500
                      ${
                        isActive
                  ...
                  >
                    <img
                      src={cliente}
                      alt="Cliente"
                      className="absolute top-9 left-9 w-[81px] h-[81px]"
                    />

                    <img
                      src={comillas}
                      alt="Comillas"
                      className="absolute top-11 right-10 w-[75px]"
                    />
                    ...
                    <div className="absolute bottom-10 left-[70px] right-[70px] flex items-center justify-between">
                      <div>
                        <span className="block font-semibold text-[22px] text-white">
                          {item.nombre}
                        </span>
